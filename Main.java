...
public class Main {
  ...
  Scanner ler = new Scanner(System.in);
        ...
        F1.setSalariomensal((float) 0.0);

        System.out.println("Qual o salario do " +F1.getNome() + (" ") + F1.getSobrenome() );

//nao entendi se era o objetivo deixar o usuario optar pelo valor 15 salario entao por via das duvidas fiz a leitura de dados
